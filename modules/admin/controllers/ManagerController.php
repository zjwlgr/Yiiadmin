...
class ManagerController extends CommonController
{
    ...
    public function actionAdd(){
        $model = new ManagerInfo(['scenario' => 'register']);
    ...
    public function actionUp(){
        $model = new ManagerInfo(['scenario' => 'editor']);
        $ManagerInfoPost = Yii::$app->request->post('ManagerInfo');
        $model->attributes = $ManagerInfoPost;
        if($model->validate() && $model->load(Yii::$app->request->post())){
    ...
    public function actionEditpwd(){
        $model = new ManagerInfo(['scenario' => 'editpwd']);
        $ManagerInfoPost = Yii::$app->request->post('ManagerInfo');
        $model->attributes = $ManagerInfoPost;
        if($model->validate() && $model->load(Yii::$app->request->post())){
            ...
            return $this->render('editpwd',['id' => $manager_session['id']]);
        }
