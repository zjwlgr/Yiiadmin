        ...
        <div class="dropdown" style="float: right;">
            <button class="btn btn-default dropdown-toggle" type="button" id="dropdownMenu1" data-toggle="dropdown">
                ...
                foreach($select_list as $val){
                    if($val['id'] == Yii::$app->request->get('groupid')){
                        $sgstr = $val['gname'];
                        break;
                    }
                }
            ...
            <ul class="dropdown-menu" role="menu" aria-labelledby="dropdownMenu1">
                ...
                <li role="presentation"><a role="menuitem" tabindex="-1" href="<?= Url::to(['manager/list', 'groupid' => $val['id']]) ?>"><?= $val['gname'] ?></a></li>
                <?php }?>
            </ul>
        </div>
    ...
    <div class="bs-center">
        ...
        <table class="table table-bordered table-hover">
            ...
            <tr>
                ...
                <td><?= $val['uname'] ?></td>
                <td>
                    <?php if($val['group_id'] == 1){echo '<strong>'.$val['groupname'].'</strong>';}else{?>
