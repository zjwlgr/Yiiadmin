...
<div class="row">
    <div class="col-md-8 my-colmd-8">
        ...
        <ol class="breadcrumb my-breadcrumb">
            ...
            <li><a href="<?= Url::to(['index/list', 'class' => strtolower($find['class_one'])]) ?>"><?= $find['class_one'] ?></a></li>
            <li><a href="<?= Url::to(['index/list', 'class' => strtolower($find['class_two'])]) ?>"><?= $find['class_two'] ?></a></li>
        </ol>

        <div class="box-con">
            <h2 class="box-title box-content">
                <?= $find['title'] ?>
            </h2>
            <div class="box-twig twig-color">
                <span class="date"><?= \yii\helpers\MyHelper::en_time($find['ctime']) ?></span>
                ...
                <span class="comments-wrapper">
                    <span class="glyphicon glyphicon-eye-open my-eye-open"></span><?= $find['click_num'] ?>
                </span>
            </div>
