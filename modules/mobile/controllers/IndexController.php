...
class IndexController extends CommonController
{
    ...
    public function actionIndex(){
        ...
        $Article = Article::article_list(10,$page);
        return $this->render('index',$Article);
    }

    public function actionList(){
        $classname = Yii::$app->request->get('class');
        $classname = $classname == 'js' ? 'javascript' : $classname;
        $page = Yii::$app->request->get('page');
        ...
        $Article = Article::article_list(10,$page,$cla_one['id']);
    ...
    public function actionContent(){
        ...
        $find['content'] = preg_replace('/<img(.*?)>/i', '<img style="width:100%" $1>', $find['content']);
    ...
    public function actionSearch(){
        ...
        $Article = Article::article_list(10,$page,false,$sphinxIds);//model查询返回
